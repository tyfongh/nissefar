...
Config::Config(bool valid, std::string discord_token,
    ...
    : discord_token(std::move(discord_token)),
      ...
      vision_model(std::move(vision_model)), is_valid(valid),
